...
describe('rgbToHexColor', () => {
    ...
    it('should return a correct hex value if a correct rgb is given', () => {
        ...
        // Assert
        expect(result).to.be.eqls('#DF7B0C')
    })
    ...
    it('should return a correct hex value if a max rgb is given', () => {
        ...
        // Assert
        expect(result).to.be.eqls('#FFFFFF')
    })

    it('should return a correct hex value if a min rgb is given', () => {
        //Arrange
        const redValue = 0;
        const greenValue = 0;
        const blueValue = 0;
        ...
        // Assert
        expect(result).to.be.eqls('#000000')
    })
})